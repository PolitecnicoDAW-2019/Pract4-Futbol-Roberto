...
$stmtInsertion->bind_param('sssssi', $_POST['name'], $_POST['alias'], $_POST['birthdate'], $hashName, $_POST['club'], $idPosicion);
$stmtInsertion->execute();

echo json_encode(["ESTATUS" => "OK", "idUsuario" => $oConni->insert_id, "pictureName" => $hashName]); 